...
class GetTextLabels(MultilingualOBJ):
    ...
    def digest_json(self, json):
        for element in json:
            ...
            self.morning = element['morning'][self.language]
            self.afternoon = element['afternoon'][self.language]
            self.evening = element['evening'][self.language]
            self.night = element['night'][self.language]
            self.see_you = element['see_you'][self.language]
            self.come_again = element['come_again'][self.language]
            self.expected_end = element['expected_end'][self.language]
